                    ...
                    <div class="header-top-right">
                        ...
                        <div class="switcher-lang-currency">
                            ...
                            <div class="lang-switcher">
                                ...
                                <ul class="lang-list">
                                    @if(app()->getLocale() == 'en')
                                        <li class="single-lang"><span class="flag"><img src="{{asset(IMG_LANGUAGE.getLanguage('fr')->thumb)}}" alt="india"></span><a class="lang-text" href="{{route('locale.switch','fr')}}">{{ getLanguage('fr')->name }}</a></li>
                                    @elseif(app()->getLocale() == 'fr')
        ...
        <div class="container">
            <div class="header-middle-wrap">
                <div class="brand-area">
                    <a class="brand-logo" href="{{route('front')}}"><img class="brand-image" src="{{asset(GeneralSettingsImage().GeneralSettings()->Logo)}}" alt="zairito" /></a>
                </div>
                        ...
                        <div class="container">
                            <ul class="mega-menu">
                                <li class="mega-menu-item">
                                    ...
                                    <ul class="menu-items">
                                        @foreach(Category() as $item)
                                            <li class="mega-menu-items"><a class="mega-menu-link" href="{{route('category.product',$item->id)}}">{{langConverter($item->en_Category_Name,$item->fr_Category_Name)}}</a></li>
                                        @endforeach
                                    </ul>
                                </li>
                                <li class="mega-menu-item">
                                    ...
                                    <ul class="menu-items">
                                        @foreach(Brnad() as $item)
                                            <li class="mega-menu-items"><a class="mega-menu-link" href="{{route('brand.product',$item->id)}}">{{langConverter($item->en_BrandName,$item->fr_BrandName)}}</a></li>
                                        @endforeach
                                    </ul>
                                </li>
                                <li class="mega-menu-item">
